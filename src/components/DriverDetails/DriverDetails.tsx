      ...
      <div className="driver_details_wrapper">
        <div className="bg-[#7155E1] h-[100px] rounded-[8px] relative z-30 flex items-center justify-end mt-[50px]">
          <div>
            ...
            <Link href={`/dashboard/editDriverProfile/${_id}`}>
              ...
              <table className="table w-full align-middle qd-table mb0">
                <tbody>
                  <tr className="w-full border-b border-dashed ">
                    ...
                    <td>
                      <strong className="text-heading">{fullName}</strong>
                    </td>
                  </tr>
                  <tr className="w-full border-b border-dashed " >
                    <td>
                    ...
                    <td>
                      <div className="flex items-center justify-start">
                        <strong className="text-heading me3">{phoneNumber}</strong>
                      </div>
                    </td>
                  </tr>
                  <tr className="w-full border-b border-dashed ">
                    ...
                    <td>
                      <div className="d-flex align-items-center justify-content-start">
                        <strong className="me3"><a href="#" className="text-decoration-none text-heading hover-primary">{email}</a></strong>
                      </div>
                    </td>
                  </tr>
                  <tr className="w-full border-b border-dashed ">
                    ...
                    <td>
                      <strong className="text-heading">{address}</strong>
                    </td>
                  </tr>
